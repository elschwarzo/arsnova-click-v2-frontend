...
export const themes: Array<ITheme> = [
  {
    ...
    name: 'component.theme_switcher.themes.PhilipSchwarz.name',
    preview: 'component.theme_switcher.themes.PhilipSchwarz.preview',
    description: 'component.theme_switcher.themes.PhilipSchwarz.description',
    id: QuizTheme.PhilipSchwarz,
  },
];
